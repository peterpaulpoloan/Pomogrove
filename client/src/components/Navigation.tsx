...
export function Navigation() {
  ...
  return (
    <>
        ...
        <nav className="flex-1 px-4 space-y-2">
          ...
          <div className="pt-4 mt-4 border-t border-border/50">
            <button 
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-violet-500/10 text-muted-foreground hover:text-violet-600 transition-all cursor-pointer"
            >
      ...
      <MusicPlayer open={isMusicOpen} onOpenChange={setIsMusicOpen} />
    </>
  );
}
